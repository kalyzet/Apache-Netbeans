...
public class Notepad implements ActionListener{
    ...
    JMenuItem iWrap, iFontArial, iFontSans, iFontTNR, iFontSize8, iFontSize12, iFontSize16, iFontSize20, iFontSize24, iFontSize28;
    JMenu iFont, iSize;
...
//        window.add(textArea);
    ...
    public void createFormatMenu(){
        ...
        iFontSans = new JMenuItem("Comic Sans MS");
        iFontSans.addActionListener(this);
        iFontSans.setActionCommand("Comic Sans MS");
        iFont.add(iFontSans);
        ...
        iSize = new JMenu("Font Size");
        menuFormat.add(iSize);
        
        iFontSize8 = new JMenuItem("8");
        iFontSize8.addActionListener(this);
        iFontSize8.setActionCommand("size8");
        iSize.add(iFontSize8);
        
        iFontSize12 = new JMenuItem("12");
        iFontSize12.addActionListener(this);
        iFontSize12.setActionCommand("size12");
        iSize.add(iFontSize12);
        
        iFontSize16 = new JMenuItem("16");
        iFontSize16.addActionListener(this);
        iFontSize16.setActionCommand("size16");
        iSize.add(iFontSize16);
        
        iFontSize20 = new JMenuItem("20");
        iFontSize20.addActionListener(this);
        iFontSize20.setActionCommand("size20");
        iSize.add(iFontSize20);
        
        iFontSize24 = new JMenuItem("24");
        iFontSize24.addActionListener(this);
        iFontSize24.setActionCommand("size24");
        iSize.add(iFontSize24);
        
        iFontSize28 = new JMenuItem("28");
        iFontSize28.addActionListener(this);
        iFontSize28.setActionCommand("size28");
        iSize.add(iFontSize28);
    }
